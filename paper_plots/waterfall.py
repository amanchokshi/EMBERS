...
parser.add_argument(
    ...
    metavar="\b",
    default="../../tiles_data/",
    help="Path to rf data directory. Default=../../tiles_data/",
)
parser.add_argument(
    "--ref_name",
    metavar="\b",
    default="rf0XX_2019-10-10-02:30.txt",
    help="Name of ref data file. Default=rf0XX_2019-10-10-02:30.txt",
)
parser.add_argument(
    "--tile_name",
    metavar="\b",
    default="S10XX_2019-10-10-02:30.txt",
    help="Name of tile data file. Default=S10XX_2019-10-10-02:30.txt",
)
parser.add_argument(
    "--out_dir",
    metavar="\b",
    default="../embers/paper_plots",
...
rf_path = Path(f"{rf_dir}/ref_name")
tl_path = Path(f"{rf_dir}/tile_name")

if rf_path.is_file() and tl_path.is_file():
    ...
    print("Input files missing. Check paths to file")
