...
if __name__=='__main__':
    ...
    plt.plot(za, ref_prof[0][2], linewidth=1.4, alpha=1, color='#070d59', label='ORBCOMM')
    plt.scatter(za, ref_prof[0][0], color='#070d59', alpha=0.6, marker="o", s=14)
    
    plt.plot(za, ref_prof[2][2], linewidth=1.4, alpha=1, color='#5893d4', label='METEOR')
    ...
    plt.savefig(f'ref_residuals.pdf', bbox_inches='tight')
