...
if __name__=='__main__':
    ...
    plt.tight_layout()
    fig1.savefig(f'../../outputs/paper_plots/null_test_XX_slices.pdf', bbox_inches='tight')
    ...
    plt.tight_layout()
    fig2.savefig(f'../../outputs/paper_plots/null_test_YY_slices.pdf', bbox_inches='tight')
