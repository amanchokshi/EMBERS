...
def plt_null_test(
    ...
    ax.plot(zen_angle,del_beam, color='#c70039', linewidth=2.1, alpha=0.9, label=beam_label)
    
    ax.plot(zen_angle,del_fit, color='#ff8264', linewidth=2.1, alpha=0.9, label=fit_label)
