...
parser.add_argument('--interp_type', metavar='\b', default='linear', help='Type of interpolation. Ex: Cubic,Linear. Default=linear')
parser.add_argument('--interp_freq', metavar='\b', default=0.5, help='Frequency at which to interpolate, in Hertz. Must be the same as used in align_data.py. Default=0.5')
