...
parser.add_argument('--start_gain', metavar='\b', default=-50, type=int, help='Power at which RFE gain variations begin. Default: -52dBm')
parser.add_argument('--stop_gain', metavar='\b', default=-30, type=int, help='Power at which RFE gain variations saturate. Default: -28dBm')
