...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--start_date",
        metavar="\b",
        help="Date from which to start plotting waterfalls. Ex: 2019-10-10",
    )
    parser.add_argument(
        "--stop_date",
        metavar="\b",
        help="Date until which to plot waterfalls. Ex: 2019-10-11",
    )
    parser.add_argument(
        "--out_dir",
        metavar="\b",
        default="./../../outputs/decode_rf_data",
        help="Output directory. Default=./../../outputs/decode_rf_data/",
    )
